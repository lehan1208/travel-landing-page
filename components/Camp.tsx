...
const CampSite = ({backgroundImage, title, subtitle, peopleJoined}: CampSitePropsType) => {
  return (
    <div
...
const Camp = () => {
  return (
    <section className="camp-component 2xl:max-container relative flex flex-col py-10 lg:mb-10 lg:py-20 xl:mb-20">
      <div className="hide-scrollbar flex h-[340px] w-full items-start justify-start gap-8 overflow-x-auto lg:h-[400px] xl:h-[640px]">
        ...
        <CampSite
          ...
          title="Phan Dung Camp"
          subtitle="Bao Loc, Lam Dong"
          peopleJoined="12+ Joined"
        />
      </div>
      ...
      <div className="flexEnd mt-10 px-6 lg:-mt-60 lg:mr-6">
        ...
        >
          ...
          <p className="regular-14 xl:regular-16 mt-5 text-white">
            ...
            That's why we are here for the those of you who want to start an adventure.
          </p>
