  ...
  return (
    ...
    >
      ...
      <div className="relative z-20 flex flex-1 flex-col xl:w-1/2">
        ...
        />
        <h1 className="bold-52 lg:bold-88 mt-1">Ta Nang - Phan Dung Camp Area</h1>
        ...
        <div className="my-11 flex felx-wrap gap-5">
        ...
        <div className="flex sm:flex-row w-full gap-3 xs:flex-col">
          <Button title="Download App" type="button" variant="btn_green"/>
          <Button title="How we work?" type="button" startIcon="/play.svg" variant="btn_white_text"/>
        </div>
      </div>
      ...
      <div className="relative flex flex-1 items-start">
        <div className="relative z-20 w-[268px] flex flex-col gap-8 rounded-3xl bg-green-90 px-7 py-8">
          <div className="flex flex-col">
            ...
            <p className="bold-20 text-white">Lam Dong</p>
          </div>

          <div className="flexBetween">
            <div className="flex flex-col">
              <p className="regular-16 block text-gray-20">Distance</p>
              <p className="bold-20 text-white">290.5 km</p>
            </div>
            <div className="flex flex-col">
              <p className="regular-16 block text-gray-20">Elevation</p>
              <p className="bold-20 text-white">1.300 m</p>
            </div>
          </div>
        </div>
      </div>
