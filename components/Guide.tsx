      ...
      <div className="padding-container max-container w-full pb-24">
        ...
        <div className="flex flex-wrap justify-between gap-5 lg:gap-10">
          ...
          <p className="regular-16 text-gray-30 xl:max-w-[520px]">
            ...
            because we already support offline map when there is no internet connection in the field.
        ...
        <div className="absolute flex bg-white py-8 pl-5 pr-7 rounded-3xl gap-3 border shadow-md md:left-[5%] lg:top-20">
          ...
          <div className="flexBetween flex-col">
            <div className="flex w-full flex-col">
              ...
              <p className="bold-20 mt-2">Pinky Hill</p>
            </div>

            <div className="flex w-full flex-col">
              <p className="regular-16 text-gray-20">Start track</p>
              <h4 className="bold-20 mt-2 whitespace-nowrap">The Lonely Tree</h4>
            </div>
          </div>
        </div>
      </div>
