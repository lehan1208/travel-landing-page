      ...
      <div className="max-container padding-container relative w-full flex justify-end">
        ...
        <div className="z-20 flex w-full flex-col lg:w-[60%]">
          <div className="relative">
            <Image src="/camp.svg" alt="camp" width={50} height={50} className="absolute left-[-5px] top-[-28px] lg:w-[50px]"/>
...
const FeatureItem = ({title, icon, variant, description}: FeatureItemTypes) => {
  return (
